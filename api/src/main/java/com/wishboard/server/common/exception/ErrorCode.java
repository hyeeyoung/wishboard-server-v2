...
public enum ErrorCode {
	...
	VALIDATION_IMAGE_SIZE_EXCEPTION(BAD_REQUEST, "이미지 1개당 최대 크기는 10MB 입니다."),
	VALIDATION_MULTIPART_MAX_SIZE_LIMIT_EXCEPTION(BAD_REQUEST, "멀티파트 업로드 용량은 최대 150MB 까지만 가능합니다."),
	VALIDATION_FOLDER_NAME_DUPLICATE_EXCEPTION(BAD_REQUEST, "이미 존재하는 폴더명입니다."),
	VALIDATION_FOLDER_ID_DUPLICATE_EXCEPTION(BAD_REQUEST, "요청된 폴더 ID 목록에 중복이 있습니다."),
	VALIDATION_FOLDER_ID_REQUIRED_ALL_EXCEPTION(BAD_REQUEST, "사용자의 전체 폴더 ID를 모두 전달해야 합니다."),
	VALIDATION_FOLDER_ID_INVALID_EXCEPTION(BAD_REQUEST, "요청된 폴더 ID 목록에 유효하지 않은 값이 있습니다."),
